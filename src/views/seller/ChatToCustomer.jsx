        ...
        >
          ...
          <div className="flex flex-col gap-3 p-4 sticky">
            <div className="flex item-center justify-between">
              <div>
                <h2 className="text-slate-900 font-bold">Customer Message</h2>
            ...
            <div className="flex space-x-2 w-full overflow-x-auto">
              <button className="text-sm bg-slate-900 py-1.5 px-3.5 rounded-md whitespace-nowrap text-white">
                All
              </button>
              <button className="text-sm  py-1.5 px-3.5 rounded-md text-slate-900 whitespace-nowrap">
                Unread
              </button>
              <button className="text-sm  py-1.5 px-3.5 rounded-md text-slate-900 whitespace-nowrap">
                Order Related
            ...
            <div className=" flex items-center justify-center space-x-4">
              ...
              <div>
                ...
                <p className="flex items-center justify-center text-xs text-slate-500 ">
                  ...
                  <span>Re: Blue Cotton Shirt (Product)</span>
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="flex flex-col items-center w-full h-[200px] py-4 border-b border-slate-200">
            <div className="relative w-[80px] h-[80px] flex items-center justify-center rounded-full bg-slate-900 text-white border-2 border-slate-200 text-lg font-semibold">
              {letterAvaterGenerator(selectedSeller.sellerName)}
              {selectedSeller && (
          ...
          <div className=" px-3 py-4 space-y-3 border-b border-slate-200">
            <h2 className="text-lg text-slate-500 text-start">History</h2>
            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <FaShoppingBag size={16} className="text-slate-500" />{" "}
                TotalOrders from this store
              </span>{" "}
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <FaRegMessage size={16} className="text-slate-500" /> Previous
                conversations
              </span>{" "}
          ...
          <div className="flex flex-col px-3 py-4 space-y-3 border-b border-slate-200">
            ...
            <div className="px-3 py-1 border border-slate-200 rounded-xl">
              <div className=" flex items-center justify-between ">
                ...
                <button className="text-xs font-semibold border border-slate-200 text-slate-900 p-1.5 rounded-md hover:bg-slate-200 cursor-pointer transition-all">
                  View Product
                </button>
              </div>
            </div>
          ...
          <div className=" px-3 py-4 space-y-3 border-b border-slate-200">
            <h2 className="text-lg text-slate-500 text-start">Quick Actions</h2>
            <div className="flex items-center justify-between border border-slate-200 rounded-xl px-3 py-3 ">
              <span className="text-sm flex items-center justify-center gap-2 cursor-pointer text-slate-700 font-semibold">
                <FaStore size={18} className="text-slate-500" /> View Order
              </span>{" "}
            </div>

            <div className="flex items-center justify-between border border-slate-200 rounded-xl px-3 py-3 ">
              <span className="text-sm flex items-center justify-center cursor-pointer gap-2 text-slate-700 font-semibold">
                <FiPackage size={18} className="text-slate-500" /> View Product
                Page
              </span>
            </div>
          </div>
