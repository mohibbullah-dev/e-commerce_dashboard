        ...
        >
          ...
          <div className="flex flex-col items-center w-full h-[200px] py-4 border-b border-slate-200">
            ...
            <div className="flex flex-col justify-center  items-center">
              ...
              <p className="text-sm text-slate-500 ">mohibbullahn7@gmail.com</p>
          ...
          <div className=" px-3 py-4 space-y-3 border-b border-slate-200">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <CiStar size={18} className="text-orange-500" /> Total Orders
              </span>{" "}
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <FaShoppingBag size={16} className="text-slate-500" /> Total
                Spent
              </span>{" "}
              <span className="text-sm font-semibold ">$3,500.00</span>
            </div>

            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <FiPackage size={18} className="text-slate-500" /> Avg. Order
                Value
              </span>{" "}
          ...
          <div className=" px-3 py-4 space-y-3 border-b border-slate-200">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <CiStar size={18} className="text-orange-500" /> Email:
              </span>{" "}
              <span className="text-xs  ">customer@email.com</span>
            </div>

            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <FaShoppingBag size={16} className="text-slate-500" /> Phone
              </span>{" "}
              <span className="text-xs  ">+880 1XXX-XXXXXX</span>
            </div>

            <div className="flex items-center justify-between">
              <span className="text-sm flex items-center justify-center gap-2 text-slate-700">
                <FiPackage size={18} className="text-slate-500" /> default
                Addewaa
              </span>{" "}
          ...
          <div className=" px-3 py-4 space-y-3 border-b border-slate-200">
            ...
            <div className="flex items-center justify-between border border-slate-200 rounded-xl px-3 py-3 ">
              <span className="text-sm flex items-center justify-center gap-2 cursor-pointer text-slate-700 font-semibold">
                <FaStore size={18} className="text-slate-500" /> View Full
                Profile
              </span>{" "}
            </div>
            ...
            <div className="flex items-center justify-between border border-slate-200 rounded-xl px-3 py-3 ">
              <span className="text-sm flex items-center justify-center cursor-pointer gap-2 text-slate-700 font-semibold">
                <FiPackage size={18} className="text-slate-500" /> View All
                Orders
              </span>{" "}
            </div>
          </div>
