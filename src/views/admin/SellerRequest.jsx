              ...
              <tbody>
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((m, i) => (
                  <tr className="" key={i}>
                    ...
                    <td
                      scope="row"
                      className="py-4 px-4 gap-3 font-medium whitespace-nowrap"
                    >
                      mohib7@gmail.com
                    </td>
                    <td
                    ...
                    <td
                      ...
                      className="py-4 px-4 gap-3 font-medium whitespace-nowrap"
                    >
                      <Link to="/admin/seller_detail/2">
                        <BsEye
                          color="black"
                          className="bg-gray-300 hover:bg-gray-100 cursor-pointer rounded-md p-1 flex items-center justify-center w-[20px] h-[20px]"
                        />
                      </Link>
                    </td>
                  </tr>
